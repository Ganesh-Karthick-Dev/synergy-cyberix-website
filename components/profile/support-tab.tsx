        ...
        <div className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <Card className="bg-[#2a2a2a] border border-orange-500/20 p-6">
              ...
              <Button variant="outline" className="w-full border-orange-500/30 hover:bg-orange-500/10 font-medium cursor-pointer" style={{ color: '#f97316' }}>
                Visit Help Center
              </Button>
            </Card>
            <Card className="bg-[#2a2a2a] border border-orange-500/20 p-6">
          ...
          <div className="p-6 bg-gradient-to-r from-orange-500/10 to-orange-600/10 border border-orange-500/30 rounded-lg">
            ...
            <Button className="w-full bg-gradient-to-r from-orange-600 to-orange-500 hover:from-orange-700 hover:to-orange-600 text-white cursor-pointer">
              Submit Ticket
            </Button>
          </div>
        </div>
